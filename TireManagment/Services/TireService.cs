...
namespace TireManagment.Services
{
    public class TireService
    {
        ...
        {
          var tires=  context.tires.Where(t => t.TireStatus == TireStatus.New || t.TireStatus == TireStatus.Retread).Select(t => new tirewithserial() { serial = t.Serial, tierid = (int)t.TireId, size = t.Size , brand = t.Brand.Name, 
